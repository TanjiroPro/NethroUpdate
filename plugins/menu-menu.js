...
const defaultMenu = {
  before: `Hola \`%name\` soy NethroBot-MD, %greeting

乂 _\`ᴜ\` \`ꜱ\` \`ᴜ\` \`ᴀ\` \`ʀ\` \`ɪ\` \`ᴏ\`_ 乂

• _\`ɴᴏᴍʙʀᴇ\`_ :: %name
• _\`ʙᴏᴛ\`_ :: NethroBot-MD
• _\`ᴍᴏᴅᴏ\`_ :: Público
• _\`ᴀᴄᴛɪᴠᴏ\`_ :: %muptime
...
`.trimStart(),
  ...
  body: '┊➧ %cmd\n',
  footer: '╰───────────── –\n',
  after: `> By NethroBot-Md`,
}
let ppp = 'https://qu.ax/xHVpv.jpg'
...
const pp = await conn.profilePictureUrl(who, 'image').catch(_ => 'https://qu.ax/xHVpv.jpg')
