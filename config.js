...
//• ↳ ◜𝑴𝑨𝑹𝑪𝑨𝑺 𝑫𝑬 𝑨𝑮𝑼𝑨◞ • 💌
global.packname = '𝗡𝗲𝘁𝗵𝗿𝗼 𝗕𝗼𝘁 𝗣𝗿𝗼'
global.author = '@yallico.owner'
global.wm = '𝗡𝗲𝘁𝗵𝗿𝗼 𝗕𝗼𝘁 𝗣𝗿𝗼'
global.titulowm = '𝗡𝗲𝘁𝗵𝗿𝗼 𝗕𝗼𝘁 𝗣𝗿𝗼 💣'
global.titulowm2 = '𝗡𝗲𝘁𝗵𝗿𝗼 𝗕𝗼𝘁 𝗣𝗿𝗼 💣'
global.igfg = '@yallico.owner'
global.botname = '𝗡𝗲𝘁𝗵𝗿𝗼 𝗕𝗼𝘁 𝗣𝗿𝗼 💣'
global.dev = '𝗡𝗲𝘁𝗵𝗿𝗼 𝗕𝗼𝘁 𝗣𝗿𝗼 💣'
global.titu = '*[ By : Nethro x Yallico ]*'
global.textbot = 'Nethro Bot X Yallico 💣'
global.vs = '1.5.1'
...
//• ↳ ◜𝑭𝑨𝑲𝑬 𝑬𝑺𝑻𝑰𝑳𝑶◞ • 🪩
global.estilo = { key: {  fromMe: false, participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "5219992095479-1625305606@g.us" } : {}) }, message: { orderMessage: { itemCount : -999999, status: 1, surface : 1, message: '𝗡𝗲𝘁𝗵𝗿𝗼 𝗕𝗼𝘁 𝗣𝗿𝗼', orderTitle: 'packname', thumbnail: logo7, sellerJid: '0@s.whatsapp.net'}}}

global.fakegif2 = { key: { participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "5219992095479-1625305606@g.us" } : {}) }, message: { videoMessage: { title: 'Nethro Bot-MD', h: `Hmm`, seconds: '99999', gifPlayback: true, caption: '⚘݄𖠵⃕⁖𖥔.𝐁𝐢𝐞𝐧𝐯𝐞𝐧𝐢𝐝𝐨❞ ꔷ──᜔◇⃟̣̣⃕✨', jpegThumbnail: logo7 }}};

global.fakegif3 = { key: { participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "5219992095479-1625305606@g.us" } : {}) }, message: { videoMessage: { title: '𝗡𝗲𝘁𝗵𝗿𝗼 𝗕𝗼𝘁 𝗣𝗿𝗼', h: `Hmm`, seconds: '99999', gifPlayback: true, caption: '⚘݄𖠵⃕⁖M I C k e y 💣', jpegThumbnail: logo8 }}};

global.fakegif4 = { key: { participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "5219992095479-1625305606@g.us" } : {}) }, message: { videoMessage: { title: '𝗡𝗲𝘁𝗵𝗿𝗼 𝗕𝗼𝘁 𝗣𝗿𝗼', h: `Hmm`, seconds: '99999', gifPlayback: true, caption: '⚘݄𖠵⃕⁖𝐒𝐭𝐢𝐜𝐤𝐞𝐫 (^_^♪) 💥', jpegThumbnail: logo8 }}};

global.estilox = { key: {  fromMe: false, participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "5219992095479-1625305606@g.us" } : {}) }, message: { orderMessage: { itemCount : -999999, status: 1, surface : 1, message: '𝗡𝗲𝘁𝗵𝗿𝗼 𝗕𝗼𝘁 𝗣𝗿𝗼', orderTitle: 'packname', thumbnail: logo7, sellerJid: '0@s.whatsapp.net'}}}
...
global.bgp2 = 'https://chat.whatsapp.com/H30owcWRukI9AkiqTdZYez' //GRUPO GLOBAL 1
global.bgp3 = 'https://chat.whatsapp.com/H30owcWRukI9AkiqTdZYez' //GRUPO GLOBAL 2
global.bgp4 = 'https://chat.whatsapp.com/H30owcWRukI9AkiqTdZYez' //GRUPO NSFW
global.md = 'https://github.com/NethroVipPro/𝗡𝗲𝘁𝗵𝗿𝗼 𝗕𝗼𝘁 𝗣𝗿𝗼' //Github Oficial
